...
// const char *paswServer = ""; //at least 11 characters, 8 mandatory
// String ssid = "";
// String pasw = "";
// String apiToken = "";
...
// const char *fingerprint = ""; //Fingerprint of Server Certificate
...
//   http.begin(host + (String) url);
//   http.addHeader("Content-Type", "text/plain");  //Specify content-type header
//   Serial.println("HTTP request: " + requestJson + ""); //Print HTTP return code
...
//     {
//       digitalWrite(SONOFF, (boolean)state);
...
// void connectToWifi(bool setupAP = false)
// {
//   //wifi
...
//   // //Testing connection to OTA Update Service
...
//   // //Verifiing SSL of OTA Update Service
//   // if ((String) fingerprint == "" /*|| client.verify(fingerprint, host2)*/)
//   // {
